...
import CinemaInscriptionButton from './Components/CinemaInscriptionButton';
...
export default function CinemaScreen({navigation}) {
    ...
    const [cinemaActivity, setcinemaActivity] = useState(null);
        ...
        return(
            <View style={styles.container}>
                <View style={scrolled ? styles.topNavbarScrolled : styles.topNavbar}>
                    ...
                    <Image source={require("../../cinema.png")} style={styles.cinemasImage}></Image>
                </View>
                <View style={styles.cinemasScreen}>
                    <FlatList data={cinemaActivity}
                        ...
                        renderItem={({item, index}) => {
                            if(index==0 && item.activityType.idActivityType==6 && item.status=="Aprovada"){
                                return(
                                    <View style={styles.cinemaActivitiesScreenView}>
                                        <View style={styles.cinemasActivitiesTextView}>
                            ...
                            if(item.activityType.idActivityType==6 && item.status=="Aprovada"){
