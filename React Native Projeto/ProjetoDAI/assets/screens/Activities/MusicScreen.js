...
export default function MusicScreen({navigation}) {
    ...
    const [musicActivity, setmusicActivity] = useState(null);
        ...
        return(
            <View style={styles.container}>
                <View style={scrolled ? styles.topNavbarScrolled : styles.topNavbar}>
                    ...
                    <Image source={require("../../music.png")} style={styles.musicsImage}></Image>
                </View>
                <View style={styles.musicsScreen}>
                    <FlatList data={musicActivity}
                        ...
                        renderItem={({item, index}) => {
                            if(index==0 && item.activityType.idActivityType==5 && item.status=="Aprovada"){
                                return(
                                    <View style={styles.musicActivitiesScreenView}>
                                        <View style={styles.musicsActivitiesTextView}>
                            ...
                            if(item.activityType.idActivityType==5 && item.status=="Aprovada"){
